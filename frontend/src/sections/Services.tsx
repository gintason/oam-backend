import { BedDouble, Car, Gift, Link, Plane, Send, Smartphone, Store, Tv, Wrench, Zap, type LucideIcon, ShoppingBag } from "lucide-react";
...
const SERVICES: Service[] = [
  ...
  { Icon: ShoppingBag,title: "E-commerce",     desc: "Amazon, Temu, SHEIN & more.",   route: "/ecommerce",            tint: "red"   },
