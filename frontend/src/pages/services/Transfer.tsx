...
import { ArrowLeft, Send, BadgeCheck, Building2, CheckCircle2, Loader2, Plus, Search, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-mist">
      ...
      <main className="mx-auto max-w-md px-5 py-8 sm:py-10">
        ...
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-display text-xl font-semibold text-ink">{t("xferbank.title", "Send to Bank")}</h1>
            ...
            <>
              ...
              >
                {withdraw.isPending
                  ...
                  : amount ? t("xferbank.sendAmount", "Send ₦{{amount}}", { amount: Number(amount).toLocaleString() }) : t("xferbank.sendBtn", "Send to bank")}
              </button>
